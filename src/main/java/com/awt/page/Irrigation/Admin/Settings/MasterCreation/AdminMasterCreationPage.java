package com.awt.page.Irrigation.Admin.Settings.MasterCreation;
...
public class AdminMasterCreationPage extends AdminDashboardPage{
	...
	// ******* List Of Radio Button*************/
		...
		public void enterMasteName(String value) {
			...
			action.clickOn(description_text_field);
		 ...
		 * 
		 * @deprecated {Radio Button Is Not present In The page)
		 */
