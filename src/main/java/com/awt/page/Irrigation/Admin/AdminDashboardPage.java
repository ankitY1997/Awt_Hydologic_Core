...
public class AdminDashboardPage extends HomePage {
	...
	/**
	 * By help of this method we can navigate to the "equipment details page"
	 * 
	 * @return instance of EquipmentDetailsPage
	 */
	public EquipmentDetailsPage navigateToEquipmentDetailsPage() {
		// select the Setting module and click on Add/View Equipments options
		selectDropDownOptions(settings, add_view_equipments);
		return new EquipmentDetailsPage(driver);

	}

	/**
	 * help Of This Method We Can select and menus and options under the Admin
	 * Dashboard page
	 * 
